...
Markdown chrome is the literal string Revisalog (not APP_NAME, SMTP_FROM_NAME, or mail.from.name). config/mail.php from.address ignores SMTP_FROM_ADDRESS so stale Gmail SMTP env cannot become From. From name is hardcoded Revisalog.
