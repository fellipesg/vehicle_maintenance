@extends('user.vehicles.consignment')
...
<div class="mx-auto max-w-2xl px-4 py-8">
    ...
    <p class="mb-6 text-sm text-automotive-600">
        O CRLV-e está em nome de outra pessoa. Envie o PDF da <strong>procuração do proprietário</strong>.
    </p>

    <form method="POST" action="{{ route('garage.vehicles.consignment.store') }}" enctype="multipart/form-data" class="card space-y-4">
        @csrf
        <div>
